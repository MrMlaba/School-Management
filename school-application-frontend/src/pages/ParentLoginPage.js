...
const LEFT = {
  ...
  features: [
    ...
    'Check exam results as they\'re captured',
    'See announcements from the school',
    'One login for every child you have enrolled',
  ],
};
...
export default function ParentLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res  = await fetch('https://school-management-production-6167.up.railway.app/api/parent-login', {
        method: 'POST',
    ...
    <LoginShell leftProps={LEFT}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography sx={{ fontFamily: FF, fontSize: '0.88rem', color: B.muted }}>
          Sign in with the username and password given to you by the school
        </Typography>
      </Box>
